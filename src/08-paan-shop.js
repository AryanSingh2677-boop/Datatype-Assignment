...
export function createPaanOrder(basePaan, customizations) {
  ...
  let customPaanOrder = Object.assign({}, basePaan, customizations)

  return customPaanOrder
}
...
export function freezeMenu(menu) {
  ...
  let freezedMenu = Object.freeze(menu)
...
export function updatePrices(menu, increase) {
  // Your code here
  if(typeof menu != 'object' ||  menu === null ||typeof increase != "number" || Array.isArray(menu)){
    return {}
  }

  let objectEntires =  Object.fromEntries(Object.entries(menu).map(([key ,value]) => [key ,value + increase]) )
  return objectEntires
...
if(typeof specialsMenu !== "object" || specialsMenu === null || Array.isArray(specialsMenu)){
 ...
 let newOrderWithMerge = {...regularMenu , ...specialsMenu}

 return newOrderWithMerge

}


console.log(createPaanOrder({type:"meetha",price:30}, {extra:"gulkand",price:50}));

console.log(freezeMenu({meetha:30}));

console.log(updatePrices({meetha:30, saada:20}, -10));

console.log(mergeDailySpecials({meetha:30}, "meetha:40"));
