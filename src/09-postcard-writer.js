...
export function isValidPincode(code) {
  // Your code here
  let userPinCode = code 
  if(typeof code != 'string' || code.length > 6){
    return false
  }
  if(!userPinCode.startsWith(0) && code.length === 6 && /^\d+$/.test(code)){
    return true 
  }else{return false }
...
export function isFromState(address, stateCode) {
  ...
  let stateCheck = address.endsWith(stateCode)
...
export function countVowels(message) {
  // Your code here
  if(typeof message !== 'string' || message.match(/[aeiouAEIOU]/g) == 0 ){
    return 0 
  }
  let totalVowelsInMessage = message.match(/[aeiouAEIOU]/g)

  if(totalVowelsInMessage === null ){
    return 0
  }
  else {
    return totalVowelsInMessage.length
  }
  }
...
console.log(writePostcard("Yash" , "Ansh" , "How's everything going on"));

console.log(isValidPincode("1234"));

console.log(formatPostcardField("To", "Dadi ji"));

console.log(formatPostcardField("To", "Dadi ji", 8));

console.log(isFromState("Guddu, Lucknow, UP", "UP"));

console.log(isFromState("Priya, Mumbai, MH", "UP"));

console.log(countVowels("Namaste India"));

console.log(countVowels("Hy! lts"))