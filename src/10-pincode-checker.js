...
export function isValidParcelWeight(weight) {
  // Your code here
  if(weight === Infinity  || typeof weight !== 'number' || weight <= 0 || Number.isNaN(weight)){
    return false 
  }
...
export function isWholeNumber(value) {
  // Your code here
  if(typeof value !== "number" || Number.isNaN(value) || value === Infinity || !Number.isInteger(value)){
    return false
  }
...
export function isTruthy(value) {
  // Your code here
  if( value === null ||  value === undefined || Number.isNaN(value) || value === '' || value === false || value === 0){
    return false
  }
...
console.log(getDataType("asdfghjkl"))
console.log(getDataType(["asdfghjk", "sdfghjkl","ASDFGHJKL"]))
console.log(getDataType(null))
console.log(getDataType([]))
console.log(getDataType(true))
console.log(getDataType(null))
console.log(getDataType({}))
console.log(getDataType(isTruthy()))

console.log(isValidParcelWeight(NaN));

console.log(isWholeNumber(123.123));

console.log(isNotANumber(NaN));

console.log(isTruthy({asdfgh:"asdfghjkl"}))