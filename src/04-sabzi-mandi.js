...
export function addUrgentItem(cart, item) {
  ...
  let cartpriority = cart
  cartpriority = cart.unshift(item)
...
console.log(addToCart(["Potato" , "Tomato"], ""));

console.log(addUrgentItem(["pyaaz" , "mirchi" , "dhaniya"] , "Onino"));

console.log(removeLastItem(["tomota", "potato", "pyaaz"]));

console.log(isInCart(["tamatar" , "pyaaz"] , "allu"));

console.log(mergeCarts(["tamatar" , "adrak"], "allu" , ""));
