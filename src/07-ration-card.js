...
export function getFamilyNames(registry) {
  ...
  let rationIds = Object.keys(registry)
...
export function getAllFamilies(registry) {
  ...
  let familyInfo = Object.values(registry)
...
export function getRationCardEntries(registry) {
  ...
  let rationCardDetails = Object.entries(registry)
...
export function hasRationCard(registry, cardId) {
  ...
  let isFoodCard = registry.hasOwnProperty(cardId)
...
export function removeRationCard(registry, cardId) {
  ...
  let exist  =  registry.hasOwnProperty(cardId) 
  if(exist){
...
console.log({
 ...
 console.log(getAllFamilies({"RC001":{head:"Ram"}}));

 console.log(getRationCardEntries({"RC001":{head:"Ram"}}));

 console.log(hasRationCard({"RC001":{head:"Ram"}}, "RC001"));

 console.log(hasRationCard({"RC001":{head:"Ram"}}, "RC000"));
 
 console.log(removeRationCard({"RC001":{head:"Ram"}}, "RC01"));

 console.log(removeRationCard({"RC001":{head:"Ram"}}, "RC001"));